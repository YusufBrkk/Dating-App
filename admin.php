...
// Randevu Durumlarına Göre Dağılım (Pie Chart)
new Chart(document.getElementById('statusChart').getContext('2d'), {
    type: 'pie',
    data: {
        labels: ['Onaylandı', 'Bekliyor', 'Reddedildi'],
        datasets: [{
            data: [<?= $onaylananCount ?>, <?= $bekleyenCount ?>, <?= $reddedilenCount ?>],
...
new Chart(document.getElementById('peakHourChart').getContext('2d'), {
    type: 'bar',
    data: {
        labels: <?= json_encode($peakHours) ?>,
        datasets: [{
            label: 'Randevu Sayısı',
            data: <?= json_encode($peakHoursData) ?>,
...
// En Yoğun Günler (Top 5)
new Chart(document.getElementById('peakDayChart').getContext('2d'), {
    type: 'bar',
    data: {
        labels: <?= json_encode($peakDays) ?>,
        datasets: [{
            label: 'Randevu Sayısı',
            data: <?= json_encode($peakDaysData) ?>,
...
// Kullanıcı Başına Randevu (Top 7)
new Chart(document.getElementById('userAvgChart').getContext('2d'), {
    type: 'bar',
    data: {
        labels: <?= json_encode($userAvgLabels) ?>,
        datasets: [{
            label: 'Randevu Sayısı',
            data: <?= json_encode($userAvgData) ?>,
